...
int main()
{
    ...
    if (quantidade_profissionais[0] == 1)
    { //Pedreiro
    ...
    if (quantidade_profissionais[1] == 1)
    { //Eletricista
        printf("Quantidade de dias de trabalho: ");
    ...
    if (quantidade_profissionais[2] == 1)
    { //Encanador
        printf("Quantidade de dias de trabalho: ");
    ...
    if (quantidade_profissionais[3] == 1)
    { //Pintor
        printf("Quantidade de dias de trabalho: ");
    ...
    valor_profissionais[4] = quantidade_profissionais[0] * quantidade_dias[0] * 50 + quantidade_profissionais[1] * quantidade_dias[1] * 50 + quantidade_profissionais[2] * quantidade_dias[2] * 50 + quantidade_profissionais[3] * quantidade_dias[3] * 50; //Ajudante
    ...
    {
    case 1:
        valor_acabamento = area * 950;
        break;
    case 2:
        valor_acabamento = area * 720;
        break;
    default:
        valor_acabamento = area * 450;
        break;
    }
